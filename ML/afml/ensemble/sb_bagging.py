...
Codes referenced to:
(1) Mizarlabs https://mizarlabs.readthedocs.io/en/stable/mizarlabs.model.html#module-mizarlabs.model.sequentially_bootstrapped_bagging_classifier
(2) Depreciated repo on https://github.com/mnewls/MLFINLAB For latest development, refer to https://github.com/hudson-and-thames/mlfinlab
...
from afml.sampling.bootstrapping import seq_bootstrap, get_ind_matrix
