...
def get_firstbarrier_touchtime(close, events, pt_sl, molecule):
    ...
    :param ptSl: A list of two non-negative float values:
        ...
        pt_sl[1]: The factor that multiplies trgt to set the width of the lower barrier. If 0, there will not be a lower barrier.
...
def get_events(close, t_events, pt_sl, target, min_ret, num_threads, vertical_barrier_times=False,
    ...
    first_touch_dates = mp_pandas_obj(func=get_firstbarrier_touchtime,
